...
final class MenuItemView: UIControl {
    ...
    private lazy var iconImageView: UIImageView = {
        ...
        imageView.tintColor = Session.shared.highLightColor
    ...
    private func setupView(){
        ...
        addTarget(self, action: #selector(handleMenuItemViewTap), for: .touchUpInside)
    }
...
extension MenuItemView {
    ...
    @objc func handleMenuItemViewTap(){
        delegate?.handleMenuItemViewTap(basedOn: self.key ?? .team)
    }
